...
/**
 * @Route(path="/crud/librarian")
 */
class LibrarianUserController extends AbstractController
{
    ...
    public function add(Request $request): Response
    {
        ...
        return $this->render(
            'default/crud/user/librarian/add.html.twig',
            [
    ...
    public function edit(Request $request, int $id): Response
    {
        ...
        return $this->render(
            'default/crud/user/librarian/edit.html.twig',
            [
                'id'   => $id,
                'form' => $form->createView(),
            ]
